...
//sql.close();
//recipe.categories = await Category.readAllByRecipe(recipe.id);
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                for(let i = 0; i < obj.prepSteps.length; i++){
                    ...
                    .query('INSERT INTO vuPREPARATION (FK_recipeID, prepStep, prepStepNumber) VALUES (@recipeID, @prepStep, @prepStepNumber)'); 
                }
